...
各香りに含まれる分子は情報が公開されているサイトまたは報告書から引用しました @<fn>{NARO_rose} @<fn>{NARO_lily} @<fn>{straw_1} @<ft>{straw_2}。
...
//image[rep_mols][特徴的な分子][scale=0.5]
...
//image[search_mol][群知能によって得られた中間分子の一つ][scale=0.5]
